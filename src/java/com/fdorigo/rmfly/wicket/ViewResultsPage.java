 ...
 */
public final class ViewResultsPage extends BasePage {
    ...
    private static final Logger LOG = Logger.getLogger(ViewResultsPage.class.getName());
    ...
    public ViewResultsPage(PageParameters params) {
